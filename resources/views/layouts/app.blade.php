...
<head>
    ...
    @stack('styles')
    <title>RP-SIGEDO - @yield('title')</title>
...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between">
            <a href="/">
                <h1 class="text-3xl font-black">RP-SIGEDO</h1>
            </a>
            ...
            @guest
            <nav class="flex gap-2 items-center">
                <a href="{{-- {{ route('login') }} --}}/login" class="font-bold uppercase text-gray-600 text-sm">Login</a>
